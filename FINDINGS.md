...
This document summarizes the current reverse-engineering results and hardware validation for the AX88179 Wii U Aroma driver.
...
AX now reproduces this exactly:
...
* NSSL over AX88179
* level download
* launching the downloaded level
* gameplay
...
This is currently the strongest real-world validation of the networking stack.
...
The final goal is normal Wii U networking through AX88179 without requiring Wi-Fi.
